...
#set cbrange [0.82:0.98]

plot 'avsdmoead2obj.txt' matrix using 1:2:3 with image title '', '' matrix using 1:2:(sprintf("%.3f", $3)) with labels title '' textcolor "green"
