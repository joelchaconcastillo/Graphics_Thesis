...
plot for [i=0:STATS_blocks-1] "AVSDMOEAD_2" using (8*i):2 index i lt 1 lc rgb 'white'title '',\
     for [i=0:STATS_blocks-1] "AVSDMOEAD_2" using (8*i):(-1):xticlabel(1) index i w l notitle
