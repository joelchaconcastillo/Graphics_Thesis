algname=(NSGA-II NSGA-III R2-EMOA MOEA_D VSD-MOEA_D)
# algname=(R2-EMOA)
 ...
 #	       >>${algname[${cont}]}/${i}_2
 	      ...
 	      v2=$(./hv -r "2.2 4.4" ../Optimals/${i}_2.txt )
              echo print ${v2} | perl  >> ${algname[${cont}]}/${i}_2
